    ...
    <>
        ...
        <section className="vls-sections service-v2">
            <div className="container">
                ...
                >
                    ...
                    <h2>
                        We create progress by design <br /> development craft digital
                        experiences.
                    </h2>
                    <p className="mw-100">
            ...
            <div
                className="mile-vl-sec wow slideInLeft"
                data-wow-duration="1000ms"
                data-wow-delay="0ms"
            >
                <div className="container">
            ...
            >
              ...
              <span className="vl-icon clr2">
                <i className="lni lni-mobile" />
                            ...
                            <h3>Interaction</h3>
                            <p>
                                Optimized UI/UX for digital products,help business grow more
                            </p>
                            <a href="#" title="">
                                See Projects
                            </a>
            ...
            <div
                className="mile-vl-sec wow slideInRight"
                data-wow-duration="1000ms"
                data-wow-delay="0ms"
            >
                <div className="container">
              ...
              <span className="vl-icon clr3">
                <i className="lni lni-anchor" />
                            ...
                            <h3>Illustration</h3>
                            <p>
                                Decribe things abstract become visible with a look impressive
                            </p>
                            <a href="#" title="">
                                See Projects
                            </a>
        ...
        <section className="clients-sec-v3 pb-0">
            ...
            Work with many big brands, brings for me great experience.
                ...
                <ul
                    className="counter-sec border-bottom wow fadeInUp"
                    id="counter"
                    data-wow-duration="1000ms"
                    data-wow-delay="0ms"
                >
