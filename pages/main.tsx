                ...
                <div className="container">
                    <div className="row">
                        <div className="col-12">
                            <div
                                className="main-txt text-center wow fadeInUp"
                        ...
                        <div className="col-12">
                            ...
                            >
                                <img
                                    ...
                                    src="/static/images/hero-main-2.png"
                                    alt=""
                                />
                            </div>
                        </div>
                ...
                <div className="container">
                    <div className="row justify-content-center">
                        <div className="col-12 col-lg-6 text-center">
                            ...
                            <p className="mt-2">
                                Gorgeus &amp; Adaptive pre-made demo templates help showcase your
                                portfolio in the best look
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="row justify-content-between flex-wrap examples-projects__block text-center">
                        ...
                        >
                            <div className="pb-5">
                                <a href="index3.html">
                                    ...
                                    <h4 className="text-uppercase mt-5 text-black font-xl">
                                        freelancer
                                    </h4>
                                </a>
                            </div>
                        ...
                        >
                            <div className="pb-5">
                                <a href="index8.html">
                                    <img
                                        src="/static/images/business-agency.png"
                                        alt="Business Agency"
                                    />
                                    <h4 className="text-uppercase mt-5 text-black font-xl">
                                        agency
                        ...
                        >
                            <div className="pb-5">
                                <a href="index6.html">
                                    <img
                                        src="/static/images/business-startup.png"
                        ...
                        >
                            <div className="pb-5">
                                <a href="index8.html">
                                    <img
                                        src="/static/images/marketing-agency.png"
                        ...
                        >
                            <div className="pb-5">
                                <a href="index9.html">
                                    <img
                                        src="/static/images/business-consulting.png"
                        ...
                        >
                            <div className="pb-5">
                                <a href="index10.html">
                                    <img
                                        src="/static/images/creative-agency.png"
                                        alt="Creative Agency"
                                    />
                                    <h4 className="text-uppercase mt-5 text-black font-xl">
                                        Creative Agency
                        ...
                        >
                            <div className="pb-5">
                                <a href="index11.html">
                                    <img
                                        src="/static/images/creative-agency2.png"
                        ...
                        >
                            <div className="pb-5">
                                <a href="index12.html">
                                    <img
                                        src="/static/images/business-startup.png"
                                        alt="Full screen parallax 1"
                                    />
                                    <h4 className="text-uppercase mt-5 text-black font-xl">
                                        Full screen parallax 1
                                    </h4>
                                </a>
                            </div>
                        </div>
                            ...
                            <div className="pb-5">
                                <a href="index13.html">
                                    <img
                                        ...
                                        alt="Full screen parallax 2"
                                    />
                                    <h4 className="text-uppercase mt-5 text-black font-xl">
                                        Full screen parallax 2
                                    </h4>
                                </a>
                            </div>
                        </div>
                ...
                <div className="container">
                    <div className="row justify-content-center">
                        <div className="col-12 col-lg-6 text-center">
                            ...
                            <p className="mt-2">
                                With many layouts as carousel, masonry, parallax, you can easy to
                                custom your portfolio items and showcase it like the way that you
                                want
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="row justify-content-center text-center">
                        <div
                            className="col-12 col-md-12 col-lg-12 wow fadeInUp"
                            data-wow-duration="2000ms"
                            data-wow-delay="0ms"
                        >
                    ...
                    <div className="row justify-content-center">
                        <div className="col-12 col-lg-6 text-center">
                            ...
                            <p className="mt-4 mb-5">
                                Multiple way to express your through via format. Show your post in
                                different way by using blog layout
                            </p>
                        </div>
                    </div>
                ...
                <div className="container">
                    <div className="row justify-content-center">
                        <div className="col-12 col-lg-6 text-center">
                            ...
                            <p className="mt-4 mb-5">
                                Detailed pages increase your efficiency and help you tell your
                                story or promote your services
                            </p>
                        </div>
                    </div>
                </div>
                <div className="container-fluid overflow-hidden px-0">
                    <div className="row grid-img justify-content-end">
                        <div className="col-7 mb-5">
                            <img
                                className="solo-img"
                                src="/static/images/pre-made-1.png"
                                alt=""
                            />
                        </div>
                    </div>
                    <div className="row justify-content-end">
                        <div className="col-7 mb-5">
                            <img
                                className="solo-img"
                                src="/static/images/pre-made-2.png"
                                alt=""
                            />
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-3 d-none d-xl-block col-xl-3 ">
                            <img
                                className="sm-img"
                                src="/static/images/pre-made-3.png"
                                alt=""
                            />
                        </div>
                        ...
                        <div className="col-3 d-none d-xl-block col-xl-3">
                            <img
                                className="md-img d-inline-block"
                                src="/static/images/pre-made-5.png"
                                alt=""
                            />
                        </div>
                    </div>
