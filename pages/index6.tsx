                        ...
                        <ul className="counter-sec-v6 wow fadeInUp" id="counter" data-wow-duration="1000ms" data-wow-delay="0ms">
                                ...
                                <div className="counter-cont">
                                    <VisibilitySensor scrollCheck partialVisibility offset={{ bottom: 10 }}>
                                        {({ isVisible }: { isVisible: boolean }) => (
                                            <h2 className="clr2 count">{isVisible ? <CountUp end={820} /> : '0'}</h2>
                                        )}
                                    </VisibilitySensor>
                            ...
                            <li>
                                <div className="counter-cont">
                                    <VisibilitySensor scrollCheck partialVisibility offset={{ bottom: 10 }}>
                                        {({ isVisible }: { isVisible: boolean }) => (
                                            <h2 className="clr2 count">{isVisible ? <CountUp end={643} /> : '0'}</h2>
                                        )}
                                    </VisibilitySensor>
                            ...
                            <li>
                                <div className="counter-cont">
                                    <VisibilitySensor scrollCheck partialVisibility offset={{ bottom: 10 }}>
                                        {({ isVisible }: { isVisible: boolean }) => (
                                            <h2 className="clr2 count">{isVisible ? <CountUp end={1875} /> : '0'}</h2>
                                        )}
                                    </VisibilitySensor>
